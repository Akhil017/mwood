        ...
        <Card>
          <CardContent className="p-0">
            ...
            <CardHeader className="pt-0 space-y-4">
              ...
              <CardDescription>
                Quis ad ipsum tempor labore ad in eiusmod duis aliqua. Proident
                esse proident labore quis dolore exercitation incididunt nulla
                reprehenderit nisi cupidatat sunt. Duis ut ut est culpa laborum
                cillum. Dolore et tempor nisi labore non.
              </CardDescription>
            </CardHeader>
          </CardContent>
        </Card>
